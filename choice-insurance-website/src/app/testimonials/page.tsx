...
export default function TestimonialsPage() {
  return (
    <div className="container mx-auto py-12 px-4">
      <h1 className="text-4xl font-bold text-center mb-10 text-blue-700">What Our Clients Say</h1>
        ...
        {testimonials.map((testimonial, index) => (
          <div key={index} className="bg-white p-6 rounded-lg shadow-lg flex flex-col">
            <blockquote className="text-gray-700 italic mb-4 flex-grow">
              <p className="before:content-[\'\“\'] before:mr-1 before:text-2xl before:font-serif after:content-[\'\”\'] after:ml-1 after:text-2xl after:font-serif">
                {testimonial.quote}
              </p>
            </blockquote>
      ...
      <section className="text-center py-16 mt-12 bg-gray-100 rounded-lg">
        <h2 className="text-3xl font-semibold mb-6 text-gray-800">Share Your Experience or Get in Touch!</h2>
